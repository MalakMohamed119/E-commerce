...
export class CheckoutComponent implements OnInit, OnDestroy {
	...
	ngOnInit(): void {
		...
		// If returning from payment gateway, redirect to orders
		const redirectToOrders = sessionStorage.getItem('redirectToOrdersAfterPayment');
		if (redirectToOrders === 'true') {
			sessionStorage.removeItem('redirectToOrdersAfterPayment');
	...
	private processCardPayment(orderData: any): void {
		...
		// Mark intent to redirect after returning from payment gateway
		sessionStorage.setItem('redirectToOrdersAfterPayment', 'true');
